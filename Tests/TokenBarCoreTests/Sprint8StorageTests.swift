...
struct Sprint8StorageTests {
    ...
    func rangeAggregateUsesSQLiteWindowAndGroupedRows() throws {
        ...
        _ = try repository.insertCheckpoint(
            ...
            events: [
                ...
                dbEvent(id: "codex-b", agent: .codex, projectName: "observ", sessionId: "c", timestamp: yesterday, inputTokens: 3, outputTokens: 2, cacheTokens: 1),
        ...
        #expect(projects.map(\.name) == ["tokenbar", "observ"])
        ...
        _ = try repository.insertCheckpoint(
            ...
            prompts: [
                ...
                PromptRecord(
                    ...
                    timestamp: oldest,
                    content: "/v1/olap/sql keep amodelsemantic API style",
    ...
    func customSourceDiscoversNestedClaudeProjectsRecursively() async throws {
        ...
        let nested = directory
            .appendingPathComponent("-Users-travis-Documents-TeamFile-claude-workspace-tokenbar")
